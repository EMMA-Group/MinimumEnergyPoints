function PlotECDF(X, sym_flag, ax)
%PLOTECDF plots the empirical cumulative distribution function of a given
%set of directions (X) to the provide axes (ax), considering the symmetry
%flag (sym_flag).
%
% See also PLOTPOINTSONSPHERE, GEODESICDISTANCE, ECDF
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Xi=GeodesicDistance(X,sym_flag);
